...
// @EnableGlobalMethodSecurity 는 @PreAuthorize 어노테이션을 메소드 단위로 추가하기 위해 적용
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // SecurityConfig는 TokenProvider JwtAuthenticationEntryPoint JwtAccessDeniedHandler 를 주입받음
